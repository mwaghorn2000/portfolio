...
export default function Home() {
  return (
    <>
      <div className="m-auto w-1/2 text-center absolute top-1/2 inset-x-0 -translate-y-2/3">
        <h1 className="text-6xl font-bold">&lt; Mitchell Waghorn /&gt;</h1>
        <h2 className="py-3 text-4xl mb-3.5">
